...
import { DribbbleIcon, GithubIcon, LinkedInIcon,LeetCodeIcon, MoonIcon, SunIcon, TwitterIcon } from './Icons';
...
const NavBar = () => {
    ...
    return(
        ...
        <button className='flex-col justify-center items-center hidden lg:flex 'onClick={handleClick}>
            <span className={`bg-dark dark:bg-light block transition-all h-0.5 w-6 rounded-sm -translate-y-0.5 ${isOpen ? 'rotate-45 translate-y-1' : '-translate-y-0.5'}`}></span>
  ...
  <nav className='flex space-x-5'>
    ...
    <CustomLink href="/contact" title="Contact"  />
           ...
           <nav className="flex items-center justify-center flex-wrap ">
            <motion.a href="https://www.linkedin.com/in/vamshi-nayak/" target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mr-3"
            >
            ...
            <motion.a href="https://github.com/vamshi-nayak" target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
            >
            ...
            <motion.a href=" https://x.com/mr_vehan?t=1NSG8GOaVjq4RRsYmgIVdg&s=08" target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
            >
            ...
            <motion.a href="https://leetcode.com/u/vamshinayak/" target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 ml-3"
            >
